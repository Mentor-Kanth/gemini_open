...
#load_dotenv()
#GOOGLE_API_KEY = os.getenv("AIzaSyB4V0YKmIoQk1BMlRkRATL011Uy9nUcFaA")
...
def get_vector_store(text_chunks):
    embeddings = OpenAIEmbeddings(openai_api_key="sk-proj-BiX1tyNA8u5Slg5Oj3IsT3BlbkFJ9OC3tSCw5Km0NCtlk16i")
...
def main():
    st.set_page_config("RAG Kanth")
    st.header("RAG Gemini PDF Q & A Chatbot")
    ...
    <footer>
        <div style='visibility: visible;margin-top:7rem;justify-content:center;display:flex;'>
            <p style="font-size:1.1rem;">
                Made by ARK
                &nbsp;
                <a href="https://www.linkedin.com/in/rajeev-kanth-6222a618a">
                ...
                &nbsp;
                <a href="https://github.com/kanth.mentor">
